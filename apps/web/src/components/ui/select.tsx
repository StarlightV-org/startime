...
function SelectValue({
	...
	placeholder,
	...props
}: SelectPrimitive.Value.Props & { fallback?: React.ReactNode }) {
	return (
...
function SelectContent({
	...
	...props
}: SelectPrimitive.Popup.Props & { position?: string } & Pick<
