...
const Webstorm = (props: SVGProps<SVGSVGElement>) => {
	const idPrefix = `webstorm-${useId()}`;

	return (
		<svg {...props} xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 105 105">
			<linearGradient id={`${idPrefix}-a`} x1="38.88" x2="63.72" y1="6.5" y2="95.94" gradientUnits="userSpaceOnUse">
				<stop offset=".28" stopColor="#07c3f2" />
				<stop offset=".94" stopColor="#087cfa" />
			</linearGradient>
			<linearGradient id={`${idPrefix}-b`} x1="46.63" x2="88.66" y1="17.85" y2="79.48" gradientUnits="userSpaceOnUse">
				<stop offset=".14" stopColor="#fcf84a" />
				<stop offset=".37" stopColor="#07c3f2" />
			</linearGradient>
			<linearGradient xlinkHref={`#${idPrefix}-a`} id={`${idPrefix}-c`} x1="88.27" x2="93.79" y1="25.47" y2="45.02" />
			<path
				fill={`url(#${idPrefix}-a)`}
			...
			/>
			<path fill={`url(#${idPrefix}-c)`} d="M81.27 32.45 90 47.96l10.5-10.95-7.71-19.06z" />
