...
const VisualStudio = (props: SVGProps<SVGSVGElement>) => (
	<svg {...props} xmlnsXlink="http://www.w3.org/1999/xlink" fill="none" viewBox="0 0 193 193">
		<defs>
			<path id="visual-studio-reuse-0" fill="#fff" d="M8.271 8.271h176.457v176.457H8.271z" />
		</defs>
		<g clipPath="url(#visual-studio-a)">
			<g clipPath="url(#visual-studio-b)">
				<mask
					id="visual-studio-c"
					width="177"
					height="177"
				...
				<g mask="url(#visual-studio-c)">
					...
					/>
					<g filter="url(#visual-studio-d)">
						<path
							fill="url(#visual-studio-e)"
					...
					<g filter="url(#visual-studio-f)">
						<path
							fill="url(#visual-studio-g)"
					...
					<g filter="url(#visual-studio-h)">
						<path
							fill="url(#visual-studio-i)"
		...
		<defs>
			<linearGradient id="visual-studio-e" x1="151.642" x2="20.614" y1="8.271" y2="140.148" gradientUnits="userSpaceOnUse">
			...
			<clipPath id="visual-studio-a">
				<use xlinkHref="#visual-studio-reuse-0" />
			</clipPath>
			<clipPath id="visual-studio-b">
				<use xlinkHref="#visual-studio-reuse-0" />
			</clipPath>
		</defs>
	</svg>
